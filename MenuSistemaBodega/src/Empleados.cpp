...
void Empleados::menuEmpleados() { // Método para mostrar el menú principal de empleados.
    ...
    do {
        ...
        cout << "\n2. Desplegar Empleados"; // Opción para mostrar todos los empleados.
        cout << "\n3. Salir"; // Opción para salir del menú.
        ...
        switch (opcion) { // Estructura de control para manejar la opción seleccionada.
            ...
            case 2: desplegarEmpleados(); break; // Llama al método para mostrar todos los empleados.
            case 3:
